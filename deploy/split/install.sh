...
cp kegtron-scanner.service /etc/systemd/system/
...
echo "3. Enable the service: sudo systemctl enable kegtron-api && sudo systemctl enable kegtron-scanner"
echo "4. Start the service: sudo systemctl start kegtron-api && sudo systemctl start kegtron-scanner"
echo "5. Check status: sudo systemctl status kegtron-api && sudo systemctl status kegtron-scanner"